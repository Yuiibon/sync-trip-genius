...
export const Route = createFileRoute("/signup")({
  ...
  head: () => ({
    meta: [
      { title: "Create Your Organizer Account — CoJourney" },
      {
        name: "description",
        content:
          "Sign up as a trip organizer on CoJourney and start collecting anonymous group preferences with one link.",
      },
      { property: "og:title", content: "Create Your Organizer Account — CoJourney" },
      {
