...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "CoJourney — Plan Together. Decide Faster. Travel Better." },
      {
        name: "description",
        content:
          "One WhatsApp link collects everyone's dates, budget and interests anonymously. CoJourney turns them into compatible trip plans and a final itinerary.",
      },
      { property: "og:title", content: "CoJourney — Plan Together. Decide Faster. Travel Better." },
      {
          ...
          <div className="mx-auto grid max-w-7xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-2 lg:py-24">
            <div className="animate-rise">
              ...
              <p className="mt-6 max-w-xl text-base text-muted-foreground sm:text-lg">
                CoJourney brings everyone's availability, budget, and interests together to
            ...
            <div className="relative">
              ...
              <img
                src={heroImage}
                alt="CoJourney dashboard showing an itinerary timeline, availability heatmap and connected group members"
                width={1600}
                height={1200}
